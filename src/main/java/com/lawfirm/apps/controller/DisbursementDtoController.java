...
//                                
                    ...
                    if (number_of_disbursement == 2) {
                        previous_disbursement_team = entityPeriodService.previousDisbursement(2, object.getId_employee(), tax_year);
                    ...
                    if (number_of_disbursement == 3) {
                        previous_disbursement_team = entityPeriodService.previousDisbursement(3, object.getId_employee(), tax_year);
                        if (previous_disbursement_team == null || previous_disbursement_team == 0d) {
                            previous_disbursement_team = 0d;
...
//                                
                    ...
                    if (number_of_disbursement == 1) {
                        ...
                        income_tax_paid_on_prior_period_team = 0d;
                        EntityPeriod entityPeriod = entityPeriodService.findBy(object.getId_employee(), caseId, tax_year);
                    ...
                    if (number_of_disbursement == 2) {
                        ...
                        log.info("1, object.getId_employee() : tax_year" + object.getId_employee() + ":" + tax_year);
                        Double incomeTaxPaidOnPriorPeriod = entityPeriodService.incomeTaxPaidOnPriorPeriod(1, object.getId_employee(), tax_year);
                    ...
                    if (number_of_disbursement == 3) {
                        log.info("3, object.getId_employee() : tax_year" + object.getId_employee() + ":" + tax_year);
                        Double incomeTaxPaidOnPriorPeriod = entityPeriodService.incomeTaxPaidOnPriorPeriod(3, object.getId_employee(), tax_year);
                        if (incomeTaxPaidOnPriorPeriod != null || incomeTaxPaidOnPriorPeriod == 0d) {
                            income_tax_paid_on_prior_period_team = incomeTaxPaidOnPriorPeriod;
                        } else {
                            income_tax_paid_on_prior_period_team = 0d;
...
//                                if (total_income_fortax_purpose_team == 0) {
                    ...
                    if (Math.max(income_tax_paid_on_prior_period_team, 0) == 0d) {
                        net_income_tax_deducted_team = (income_tax_team - 0);
                    } else {
...
//                    objMember.put("net_income_tax_deducted_team", "(" + String.format("%.0f", (Math.abs(net_income_tax_deducted_team))) + ")");
                    ...
                    if (number_of_disbursement == 1) {
                        ...
                        Double outStandingAteam = this.loanService.sumLoanA(object.getId_employee(), tax_year, closeDate);
                        outstanding_loan_a_team = outStandingAteam;
                        OutStandingLoanA updateOutStandingLoanA = this.outStandingLoanAService.findBy(object.getId_employee(), tax_year, number_of_disbursement.longValue());
                    ...
                    if (number_of_disbursement == 2) {
                        ...
                        if (oldCloseDate.compareTo(closeDate) == 0) {
                            outStandingAteam = this.loanService.sumLoanA(object.getId_employee(), tax_year, closeDate);
                        } else {
                            outStandingAteam = this.loanService.sumLoanA2(object.getId_employee(), tax_year, closeDate, oldCloseDate);
                        }
